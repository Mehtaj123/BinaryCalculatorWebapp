...
public class Binary {
    ...
    /**
     * Multiplying two binary variables using the standard shift-and-add method.
     * For more information, visit <a href=
     * "https://www.wikihow.com/Multiply-Binary-Numbers">Multiply-Binary-Numbers</a>.
     *
    ...
    public static Binary multiply(Binary num1, Binary num2) {
        Binary result = new Binary("0"); // running total, starts at 0
        String multiplier = num2.number;
        int shift = 0;
        // walk the multiplier from its least significant digit
        for (int i = multiplier.length() - 1; i >= 0; i--) {
            if (multiplier.charAt(i) == '1') {
                // shift num1 left by 'shift' positions by appending zeros
    ...
    /**
     * Bitwise AND of two binary variables. The shorter operand is padded with
     * leading zeros so both operands line up before the bitwise operation.
     *
    ...
    public static Binary and(Binary num1, Binary num2) {
        ...
        String a = padLeft(num1.number, maxLen);
        String b = padLeft(num2.number, maxLen);
        StringBuilder sb = new StringBuilder();
        for (int i = 0; i < maxLen; i++) {
            boolean bit = (a.charAt(i) == '1') && (b.charAt(i) == '1');
            sb.append(bit ? '1' : '0');
        }
    ...
    /**
     * Bitwise OR of two binary variables. The shorter operand is padded with
     * leading zeros so both operands line up before the bitwise operation.
     *
     * @param num1 The first operand object
     * @param num2 The second operand object
    ...
    // helper: left-pad a binary string with '0' up to the given length
